...
public class Menu_item_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.acivity_description_recipes,container,false);
        ...
        s = write_description(getActivity().getAssets(),"sam_recept/recept" + mMenu.getNumber() + ".txt");
        s = s.replace("\n\n\n", "``");
        s = s.replace("\n\n", "``");
        ...
        Drawable drawable = loadDrawable(getActivity().getAssets(), "icon_full/"+mMenu.getImage());
        mImageView.setImageDrawable(drawable);
        mTextView = (TextView)v.findViewById(R.id.text_detaled);
        text_descriptiont = write_description(getActivity().getAssets(),"opisanie/opis"+mMenu.getNumber()+".txt");
        mTextView.setText(text_descriptiont);
        mIngredients = (TextView)v.findViewById(R.id.ingredients);
        text_ingredients = write_description(getActivity().getAssets(), "ingredienti/ing"+mMenu.getNumber()+".txt");
    ...
    private class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            Drawable drawable = loadDrawable(getActivity().getAssets(), "image/"+images1.get(position));
